...
"*" {  cur = 14; return; }
"/" {  cur = 15; return; }
[A-Za-z_][A-Za-z0-9.\-/_]* {  cur = 16; curData.reset(new STRING(*self, begin, YYCURSOR)); return; }
("-")?[0-9]+ {  cur = 17; curData.reset(new INTEGER(*self, begin, YYCURSOR)); return; }
("-")?[0-9]+"."[0-9]* {  cur = 18; curData.reset(new NUMBER(*self, begin, YYCURSOR)); return; }
[\ \r\t] { 
