...
struct GusanosFont : public BaseFont {
	GusanosFont(Font *font_) : font(font_) {}

	Font *font;
};

struct GusanosSpriteSet : public BaseSpriteSet {
	GusanosSpriteSet(SpriteSet *spriteSet_) : spriteSet(spriteSet_) {}
...
struct SDLRenderer : public Renderer {
	...
	virtual void drawFrame(Rect const &rect, RGB const &color);

	virtual void drawBox(Rect const &rect, RGB const &color);
