...
void Font::draw(BITMAP *where, string::const_iterator b, string::const_iterator e, int x, int y, CharFormatting &format,
				int spacing, int fact, int flags) {
	for (; b != e; ++b) {
		if (flags & Formatting) {
...
int Font::getTextCoordToIndex(std::string::const_iterator b, std::string::const_iterator e, int x, int spacing,
							  int flags) {
	int i = 0;
