...
void drawSprite_mult_8_to_32_mmx_sse(BITMAP *where, BITMAP *from, int x, int y, int cutl, int cutt, int cutr,
									 int cutb) {
...
#define SHUF_MASK(a, b, c, d) ((a << 6) | (b << 4) | (c << 2) | d)
	...
	SPRITE_Y_LOOP(SPRITE_X_LOOP_NOALIGN_T(4, *dest = scaleColor_32(*dest, *src),
										  ...
										  movd_rm(mm7, src[0]); movq_rm(mm1, dest[0]);
										  ...
										  pmulhuw_rr(mm2, mm4); pmulhuw_rr(mm1, mm3);
										  ...
										  pmulhuw_rr(mm1, mm3); pmulhuw_rr(mm5, mm4);
