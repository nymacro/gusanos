	...
	void name_ params_ const {                                                                                         \
		switch (m_type) {                                                                                              \
			case None:                                                                                                 \
				...
				break;                                                                                                 \
			case Add:                                                                                                  \
				name_##_add sendfact_;                                                                                 \
				break;                                                                                                 \
			case Alpha:                                                                                                \
				name_##_blend sendfact_;                                                                               \
				break;                                                                                                 \
			case AlphaChannel:                                                                                         \
				name_##_blendalpha sendfact_;                                                                          \
				break;                                                                                                 \
		}                                                                                                              \
	}

#define FUNC_6(name_, P1, P2, P3, P4, P5, P6)                                                                          \
	FUNC(name_, (P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6), (p1, p2, p3, p4, p5, p6), (p1, p2, p3, p4, p5, p6, m_fact))

#define FUNC_5(name_, P1, P2, P3, P4, P5)                                                                              \
	FUNC(name_, (P1 p1, P2 p2, P3 p3, P4 p4, P5 p5), (p1, p2, p3, p4, p5), (p1, p2, p3, p4, p5, m_fact))

#define FUNC_4(name_, P1, P2, P3, P4)                                                                                  \
	FUNC(name_, (P1 p1, P2 p2, P3 p3, P4 p4), (p1, p2, p3, p4), (p1, p2, p3, p4, m_fact))

#define FUNC_8(name_, P1, P2, P3, P4, P5, P6, P7, P8)                                                                  \
	FUNC(name_, (P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7, P8 p8), (p1, p2, p3, p4, p5, p6, p7, p8),            \
...
struct BlitterContext {
	...
	BlitterContext(alpha, int fact_) : m_type(Alpha), m_fact(fact_) {}
