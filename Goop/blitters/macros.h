...
#define CLIP_SPRITE()                                                                                                  \
	int x1, y1, x2, y2;                                                                                                \
	if (x + from->w > where->cr) {                                                                                     \
		x2 = where->cr - x;                                                                                            \
	} else                                                                                                             \
		x2 = from->w;                                                                                                  \
	if (y + from->h > where->cb) {                                                                                     \
		y2 = where->cb - y;                                                                                            \
	} else                                                                                                             \
		y2 = from->h;                                                                                                  \
	if (x < where->cl) {                                                                                               \
...
#define CLIP_SPRITE_REGION_SEC()                                                                                       \
	...
	if (sx + (x2 - x1) > secondary->cr) {                                                                              \
		x2 = secondary->cr - sx + x1;                                                                                  \
	}                                                                                                                  \
	if (sy + (y2 - y1) > secondary->cb) {                                                                              \
		y2 = secondary->cb - sy + y1;                                                                                  \
	}                                                                                                                  \
	if (sx < secondary->cl) {                                                                                          \
		int diff = secondary->cl - sx;                                                                                 \
		x1 += diff;                                                                                                    \
		sx = secondary->cl;                                                                                            \
		x += diff;                                                                                                     \
	}                                                                                                                  \
	if (sy < secondary->ct) {                                                                                          \
		int diff = secondary->ct - sy;                                                                                 \
		y1 += diff;                                                                                                    \
		sy = secondary->ct;                                                                                            \
		y += diff;                                                                                                     \
	}                                                                                                                  \
...
#define WULINE(a, b, OFFA, OFFB, DEPTH, SHIFT, MAX, BLEND)                                                             \
	{                                                                                                                  \
		...
		if (a##diff > 0) {                                                                                             \
			...
			for (; c-- > 0; ++draw##a) {                                                                               \
				int draw##b = b##f >> prec;                                                                            \
				if ((unsigned int)drawx < (unsigned int)where->w - (OFFA) &&                                           \
					(unsigned int)drawy < (unsigned int)where->h - (OFFB)) {                                           \
...
#define LINEWORK(a, b, BLEND, DEPTH)                                                                                   \
	do {                                                                                                               \
		long i = a##diff >> 1;                                                                                         \
		long c = a##diff;                                                                                              \
		while (c-- >= 0) {                                                                                             \
...
#define LINE(BLEND, DEPTH)                                                                                             \
	do {                                                                                                               \
		...
		ydiff = labs(ydiff);                                                                                           \
		if (xdiff > ydiff)                                                                                             \
			LINEWORK(x, y, BLEND, DEPTH);                                                                              \
		else                                                                                                           \
			LINEWORK(y, x, BLEND, DEPTH);                                                                              \
	} while (0)
