...
enum { ALIGN_TOP = 1, ALIGN_BOTTOM = 2, ALIGN_RIGHT = 4, ALIGN_LEFT = 16 };
...
class Sprite {
  public:
	...
	void drawCut(BITMAP *where, int x, int y, BlitterContext const &blender, int alignment, int left, int top,
