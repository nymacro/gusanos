...
int l_gfx_draw_box(lua_State *L) {
	...
	{
		LUA_WLOG_ONCE(
			"The r, g, b version of draw_box is deprecated, replace the r, g, b parameters by color(r, g, b)");
...
*/
METHOD(Viewport, viewport_getBitmap, context.pushFullReference(*p->hud, BITMAPMetaTable); return 1;)
...
*/
METHOD(BITMAP, bitmap_w, lua_pushinteger(context, p->w); return 1;)

/*! Bitmap:h()

	Returns the width of this bitmap.
*/
METHOD(BITMAP, bitmap_h, lua_pushinteger(context, p->h); return 1;)
...
#endif
			  ("bitmap", l_viewport_getBitmap)("game_bitmap", l_viewport_getGameBitmap)("from_map", l_viewport_fromMap))

	// Bitmap method and metatable

	CLASS(BITMAP,
		  ("w", l_bitmap_w)("h", l_bitmap_h)("draw_box", l_gfx_draw_box)("line", l_gfx_line)("linewu", l_gfx_linewu)(
			  "putpixelwu", l_gfx_putpixelwu)("putpixel", l_gfx_putpixel)("hline", l_gfx_hline))
