...
PosSpdReplicator::PosSpdReplicator(ZCom_ReplicatorSetup *_setup, Vec *pos, Vec *spd,
								   Encoding::VectorEncoding &encoding_, Encoding::DiffVectorEncoding &diffEncoding_)
	: ZCom_ReplicatorBasic(_setup), m_posPtr(pos), m_spdPtr(spd), m_repCount(0), encoding(encoding_),
