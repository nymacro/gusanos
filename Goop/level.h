...
struct SpawnPoint {
	SpawnPoint(const Vec &pos_, int team_) : pos(pos_), team(team_) {}
	Vec pos;
	int team;
...
#ifndef DEDSERV
	void specialDrawSprite(Sprite *sprite, BITMAP *where, const IVec &pos, const IVec &matPos,
...
#define WORK(a, b)                                                                                                     \
	{                                                                                                                  \
		...
		long c = a##diff;                                                                                              \
		while (c-- >= 0) {                                                                                             \
			if (predicate(unsafeGetMaterial(x, y)))                                                                    \
				return true;                                                                                           \
			i -= b##diff;                                                                                              \
			a += s##a;                                                                                                 \
			if (i < 0)                                                                                                 \
