...
#pragma GCC diagnostic ignored "-Waddress"
	...
	static_assert(static_cast<bool (ZCom_Address::*)(eZCom_AddressType, zU8, const char *)>(&ZCom_Address::setAddress),
				  "setAddress signature");
	// getAddressIP(eZCom_GetIPAddressOption) const -> const char*
	static_assert(
		static_cast<const char *(ZCom_Address::*)(eZCom_GetIPAddressOption) const>(&ZCom_Address::getAddressIP),
	...
	static_assert(static_cast<const char *(ZCom_Address::*)() const>(&ZCom_Address::toString), "toString signature");
	// setIP(zU8,zU8,zU8,zU8)
	static_assert(static_cast<void (ZCom_Address::*)(zU8, zU8, zU8, zU8)>(&ZCom_Address::setIP), "setIP(4) signature");
	// setIP(zU32)
	static_assert(static_cast<void (ZCom_Address::*)(zU32)>(&ZCom_Address::setIP), "setIP(zU32) signature");
	// setPort(zU16)
	static_assert(static_cast<void (ZCom_Address::*)(zU16)>(&ZCom_Address::setPort), "setPort signature");
	// setType(eZCom_AddressType)
	static_assert(static_cast<void (ZCom_Address::*)(eZCom_AddressType)>(&ZCom_Address::setType), "setType signature");
	// setControlID(zU8)
	static_assert(static_cast<void (ZCom_Address::*)(zU8)>(&ZCom_Address::setControlID), "setControlID signature");
	// getPort() const -> zU16
	static_assert(static_cast<zU16 (ZCom_Address::*)() const>(&ZCom_Address::getPort), "getPort signature");
	// getIP() const -> zU32
	static_assert(static_cast<zU32 (ZCom_Address::*)() const>(&ZCom_Address::getIP), "getIP() signature");
	// getIP(zU8) const -> zU8
	static_assert(static_cast<zU8 (ZCom_Address::*)(zU8) const>(&ZCom_Address::getIP), "getIP(zU8) signature");
	...
	static_assert(static_cast<zU8 (ZCom_Address::*)() const>(&ZCom_Address::getControlID), "getControlID signature");
