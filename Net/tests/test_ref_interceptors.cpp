...
public:
	...
	bool outPreUpdateItem(ZCom_Node* node, uint32_t to, eZCom_NodeRole remote_role, ZCom_Replicator* replicator) override
	{ called_out_pre_update_item = true; return true; }
	void outPostUpdate(ZCom_Node* node, uint32_t to, eZCom_NodeRole remote_role, uint32_t rep_bits, uint32_t event_bits, uint32_t meta_bits) override
	...
	bool inPreUpdateItem(ZCom_Node* node, uint32_t from, eZCom_NodeRole remote_role, ZCom_Replicator* replicator, uint32_t estimated_time_sent) override
	{ called_in_pre_update_item = true; return true; }
	void inPostUpdate(ZCom_Node* node, uint32_t from, eZCom_NodeRole remote_role, uint32_t rep_bits, uint32_t event_bits, uint32_t meta_bits) override
...
{
public:
	bool recUserEvent(ZCom_Node*, uint32_t, eZCom_NodeRole, ZCom_BitStream&, uint32_t) override { return true; }
	bool recInit(ZCom_Node*, uint32_t, eZCom_NodeRole) override { return true; }
	bool recSyncRequest(ZCom_Node*, uint32_t, eZCom_NodeRole) override { return true; }
	bool recRemoved(ZCom_Node*, uint32_t, eZCom_NodeRole) override { return true; }
	bool recFileIncoming(ZCom_Node*, uint32_t, eZCom_NodeRole, uint32_t, ZCom_BitStream&) override { return true; }
	bool recFileData(ZCom_Node*, uint32_t, eZCom_NodeRole, uint32_t) override { return true; }
	bool recFileAborted(ZCom_Node*, uint32_t, eZCom_NodeRole, uint32_t) override { return true; }
	bool recFileComplete(ZCom_Node*, uint32_t, eZCom_NodeRole, uint32_t) override { return true; }
};
