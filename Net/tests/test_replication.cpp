...
class ReplServer : public ZCom_Control {
  public:
	...
	ReplServer(int udpPort)
		: ZCom_Control(), m_spawnedCount(0), m_nodeRequestCount(0), m_playerClass(0), m_playerNode(nullptr) {
...
class ReplClient : public ZCom_Control {
  public:
	...
	ReplClient(int udpPort) : ZCom_Control(), m_connected(false), m_nodeRequestCount(0), m_playerClass(0) {
		m_playerClass = ZCom_registerClass("PlayerInfo", 0);
		g_currentControl = this;
